  ...
  return (
    <main className="max-w-4xl my-0 mx-auto w-full p-30 flex justify-center flex-col">
      ...
      <nav className="flex justify-between mb-12">
        ...
        {hasRate && <button onClick={handleDeleteItem} className={clsx(state.reviewContent ? "bg-greenDefault hover:bg-transparent border-2 border-greenDefault rounded-md p-1" : "none")}><FiTrash2 size="1.7em" className='w-full hover:stroke-greenDefault stroke-grayCard'/></button>}
      </nav>
