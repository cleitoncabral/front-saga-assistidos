  ...
  return (
    <div className="container w-64 h-full bg-grayCard rounded-xl">
      ...
      <div className="relative p-4">
        ...
        <Link to={`movie`} state={searchResultItem}><button className="absolute right-3 top-5 bg-greenDefault hover:bg-green-900 w-7 h-7 rounded-lg pl-1.5 pr-1.5"><span>{searchResultItem.reviewContent ? <BsFillPlayFill /> : '+ '}</span></button></Link>
